...
describe('addMuseum', () => {
    ...
    it('should be opened and return error 403 and message', async () => {
        ...
        expect(originalLoggerModule).toHaveBeenCalledWith(`Недостатньо прав: Користувач ${req.user.fullName} спробував додати карточку музею`, "Console");
