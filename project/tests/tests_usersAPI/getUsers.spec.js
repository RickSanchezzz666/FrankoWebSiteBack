...
describe('getUsers' , () => {
    ...
    it('should be opened and throw error 403 and send message and logs', async () =>{
        const req = {
            user: {
                accessLevel: 2,
        ...
        expect(originalLoggerModule).toHaveBeenCalledWith(`Недостатньо прав: Користувач ${req.user.fullName} спробував отримати список користувачів`, "Console");
    })
})
