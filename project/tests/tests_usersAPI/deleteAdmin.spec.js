...
describe('deleteAdmin', () => {
    ...
    describe('should be opened', () => {
        ...
        it('throw error 403, message and logs', async () => {
            ...
            expect(originalLoggerModule).toHaveBeenCalledWith(`Недостатньо прав: Користувач ${req.user.fullName} спробував видалити користувача`, "Console");
        })
        ...
        it('throw error 400 and message', async () => {
            ...
            expect(res.send).toHaveBeenCalledWith({ message: "Недійсний або відсутній ідентифікатор користувача" })
